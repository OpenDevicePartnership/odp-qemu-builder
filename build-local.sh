#!/usr/bin/env bash
# build-local.sh — Build QEMU locally using the builder Docker image.
#
# This mirrors what CI does: build the builder image, then run build.sh
# inside it for each architecture with persistent local caches.
#
